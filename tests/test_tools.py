...
@pytest.mark.parametrize(
    ...
    (
        ...
        ('uint', 'integers(min_value=0, max_value=115792089237316195423570985008687907853269984665640564039457584007913129639935)'),  # noqa: E501
        ('uint256', 'integers(min_value=0, max_value=115792089237316195423570985008687907853269984665640564039457584007913129639935)'),  # noqa: E501
        ...
        ('ufixed', 'decimals(min_value=0, max_value=340282366920938463463374607431768211455, places=0).map(scale_by_Eneg18)'),  # noqa: E501
        ('ufixed128x18', 'decimals(min_value=0, max_value=340282366920938463463374607431768211455, places=0).map(scale_by_Eneg18)'),  # noqa: E501
        ('fixed8x8', 'decimals(min_value=-128, max_value=127, places=0).map(scale_by_Eneg8)'),
        ('fixed16x7', 'decimals(min_value=-32768, max_value=32767, places=0).map(scale_by_Eneg7)'),
        ('fixed', 'decimals(min_value=-170141183460469231731687303715884105728, max_value=170141183460469231731687303715884105727, places=0).map(scale_by_Eneg18)'),  # noqa: E501
        ('fixed128x18', 'decimals(min_value=-170141183460469231731687303715884105728, max_value=170141183460469231731687303715884105727, places=0).map(scale_by_Eneg18)'),  # noqa: E501
        ...
        ('bool[3][]', 'lists(elements=lists(elements=booleans(), min_size=3, max_size=3))'),
        ('(bool,int8)', 'tuples(booleans(), integers(min_value=-128, max_value=127))'),
        ('(bool,(uint8,int8))', 'tuples(booleans(), tuples(integers(min_value=0, max_value=255), integers(min_value=-128, max_value=127)))'),  # noqa: E501
        ('(bool,bool)[]', 'lists(elements=tuples(booleans(), booleans()))'),
    )
)
def test_get_abi_strategy_returns_certain_strategies_for_known_type_strings(type_str, strategy_repr):  # noqa: E501
